	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ModelCheckAnticipation.leftClickAction(e,jc,panelPicture, rewardText,reqName,reqRew,total,Status, reqDescr);
			}
		});
		...
		ModelCheckAnticipation.drawInitialState(jc);
		...
		ModelCheckAnticipation.drawInitialPoint(panelPicture,reqName);
		}
}
