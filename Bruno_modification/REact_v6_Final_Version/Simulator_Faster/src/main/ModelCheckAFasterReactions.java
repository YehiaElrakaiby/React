...
public class ModelCheckAFasterReactions {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] argument1 = {"fasterReactions.AdaptiveCyberDefense", "/Users/forensics/Desktop/REact/","/Users/forensics/Documents/runtime-EclipseApplication/ReactV5-PaperExamples/",str};
		...
		for(int i = 0;i<30;i++) {
			...
			int indexState = 0;
			//Scenario 2
			reqDescr = "Description : Table2 requested (1000)\tTable1 requested (1000)";
			
			String initialState = "location=office, table1=empty, table2=empty";
