	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ModelCheckAFasterReactions.leftClickAction(e,jc,panelPicture, rewardText,reqName,reqRew,total,Status, reqDescr);
			}
		});
		...
		ModelCheckAFasterReactions.drawInitialState(jc);
		...
		ModelCheckAFasterReactions.drawInitialPoint(panelPicture,reqName);
		}
}
