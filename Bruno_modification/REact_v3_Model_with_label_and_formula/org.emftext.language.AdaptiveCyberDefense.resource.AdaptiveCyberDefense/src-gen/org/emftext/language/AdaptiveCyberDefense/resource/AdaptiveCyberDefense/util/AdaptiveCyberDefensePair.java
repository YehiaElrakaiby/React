 ...
 */
public class AdaptiveCyberDefensePair<T1, T2> {
	
	private T1 left;
	private T2 right;
	
	public AdaptiveCyberDefensePair(T1 left, T2 right) {
		this.left = left;
		this.right = right;
	}
	...
	public boolean equals(Object obj) {
		...
		AdaptiveCyberDefensePair<?,?> other = (AdaptiveCyberDefensePair<?,?>) obj;
		if (left == null) {
			if (other.left != null) {
				return false;
			}
