...
/**
 * A AdaptiveCyberDefenseLayoutInformationAdapter is used to store layout
 * information that is found while parsing text files. Layout information does
 * include all unused tokens. Usually, these are whitespace characters, line
 * breaks and comments, but depending on the concrete syntax definition it can
 * also include other tokens. AdaptiveCyberDefenseLayoutInformationAdapters are
 * attached to EObjects and aggregate multiple LayoutInformation objects. Each of
 * these objects contains the layout that was found before a keyword, attribute or
 * reference.
 * 
 ...
 */
public class AdaptiveCyberDefenseLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.mopp.AdaptiveCyberDefenseLayoutInformation> layoutInformations = new java.util.ArrayList<org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.mopp.AdaptiveCyberDefenseLayoutInformation>();
	...
	public java.util.List<org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.mopp.AdaptiveCyberDefenseLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.mopp.AdaptiveCyberDefenseLayoutInformation layoutInformation) {
