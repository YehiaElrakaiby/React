 ...
 * code).
 */
public class AdaptiveCyberDefenseDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AbstractAdaptiveCyberDefenseDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefensePair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefensePair<String, Object>>();
	...
	public AdaptiveCyberDefenseDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefenseStringUtil.encode('#', stack);
				org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage message = new org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage message = new org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_VARIABLES)) {
				...
				org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage message = new org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugMessage(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.EAdaptiveCyberDefenseDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefenseStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefensePair<String, Object> pair = new org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.util.AdaptiveCyberDefensePair<String, Object>(name, value);
	...
	public org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AbstractAdaptiveCyberDefenseDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AbstractAdaptiveCyberDefenseDebuggable debuggable) {
