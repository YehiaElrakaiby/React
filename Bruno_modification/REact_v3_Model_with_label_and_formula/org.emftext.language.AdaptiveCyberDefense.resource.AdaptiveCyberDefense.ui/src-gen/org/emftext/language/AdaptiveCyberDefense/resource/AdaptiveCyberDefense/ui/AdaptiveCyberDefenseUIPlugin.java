 ...
 */
public class AdaptiveCyberDefenseUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.ui";
	public static final String EDITOR_ID = "org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.ui.AdaptiveCyberDefenseEditor";
	...
	private static AdaptiveCyberDefenseUIPlugin plugin;
	
	public AdaptiveCyberDefenseUIPlugin() {
		super();
	}
	...
	public static AdaptiveCyberDefenseUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AdaptiveCyberDefenseUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, AdaptiveCyberDefenseUIPlugin.PLUGIN_ID, message);
		}
		final AdaptiveCyberDefenseUIPlugin pluginInstance = AdaptiveCyberDefenseUIPlugin.getDefault();
