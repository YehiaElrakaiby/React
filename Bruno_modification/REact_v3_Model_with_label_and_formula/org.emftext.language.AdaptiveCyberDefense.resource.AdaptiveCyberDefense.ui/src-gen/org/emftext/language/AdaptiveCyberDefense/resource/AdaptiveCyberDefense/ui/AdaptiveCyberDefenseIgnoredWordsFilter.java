 ...
 */
public class AdaptiveCyberDefenseIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.grammar.AdaptiveCyberDefenseGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
