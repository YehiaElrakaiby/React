...
RULES {
	...
	//Negation
	@Operator(type="unary_prefix",weight="2",superclass="PCTLStateFormula")
	PNegation ::= "!" op;
	
	@Operator(type="primitive",weight="3",superclass="PCTLStateFormula")
	LabelReference::= label[];
		
	//@Operator(type="primitive",weight="3",superclass="PCTLStateFormula")
	//LRA ::=  "LRA" operator[lessThan:"<", lessThanEquals:"<=", equals:"==", greater:">", greaterThanEquals:">="] bound[FLOAT] "["  "]";
	
	@Operator(type="primitive",weight="3",superclass="PCTLStateFormula")
	POperator ::=  type[Max:"Pmax",Min:"Pmin"] operator[lessThan:"<", lessThanEquals:"<=", equals:"==", greater:">", greaterThanEquals:">="] bound[FLOAT] "[" op "]";
