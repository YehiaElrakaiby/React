...
public enum ComparaisonOperator implements Enumerator {
	 ...
	 * @ordered
	 */
	LESS_THAN_EQUALS(2, "lessThanEquals", "lessThanEquals"),
	 ...
	 * @ordered
	 */
	GREATER_THAN_EQUALS(5, "greaterThanEquals", "greaterThanEquals");
