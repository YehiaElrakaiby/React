 ...
 * olInput</code>.
 */
public class AdaptiveCyberDefenseDocBrowserInformationControlInput {
	
	private final AdaptiveCyberDefenseDocBrowserInformationControlInput fPrevious;
	private AdaptiveCyberDefenseDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AdaptiveCyberDefenseDocBrowserInformationControlInput(AdaptiveCyberDefenseDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AdaptiveCyberDefenseDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AdaptiveCyberDefenseDocBrowserInformationControlInput getNext() {
		return fNext;
	}
