...
public class AdaptiveCyberDefenseLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.lineBreakpoint.marker";
	
	public AdaptiveCyberDefenseLineBreakpoint() {
		super();
	}
	
	public AdaptiveCyberDefenseLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugTarget target) {
		try {
	...
	public void remove(org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense.debug.AdaptiveCyberDefenseDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
