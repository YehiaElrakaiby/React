 ...
 */
public class AdaptiveCyberDefensePlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.AdaptiveCyberDefense.resource.AdaptiveCyberDefense";
	/**
	...
	private static AdaptiveCyberDefensePlugin plugin;
	
	public AdaptiveCyberDefensePlugin() {
		super();
	}
	...
	public static AdaptiveCyberDefensePlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, AdaptiveCyberDefensePlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, AdaptiveCyberDefensePlugin.PLUGIN_ID, message);
		}
		final AdaptiveCyberDefensePlugin pluginInstance = AdaptiveCyberDefensePlugin.getDefault();
