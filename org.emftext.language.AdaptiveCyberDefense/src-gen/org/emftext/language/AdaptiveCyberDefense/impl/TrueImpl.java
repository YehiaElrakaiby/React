 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.AdaptiveCyberDefense.impl.TrueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TrueImpl extends ConditionExpressionImpl implements True {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptiveCyberDefensePackage.TRUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdaptiveCyberDefensePackage.TRUE__VALUE:
				return getValue();
		}
	...
	public void getConditions(HashMap<String,String> conditions) {
		if(this.getValue().equals("ff")){
			conditions.put("TRUE", "ff");
		}
