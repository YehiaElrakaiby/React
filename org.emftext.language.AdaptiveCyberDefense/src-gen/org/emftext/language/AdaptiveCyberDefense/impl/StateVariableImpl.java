...
public class StateVariableImpl extends EObjectImpl implements StateVariable {
	...
	protected EClass eStaticClass() {
		return AdaptiveCyberDefensePackage.Literals.STATE_VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptiveCyberDefensePackage.STATE_VARIABLE__NAME, oldName, name));
	}
	...
	public EList<Value> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Value>(Value.class, this, AdaptiveCyberDefensePackage.STATE_VARIABLE__VALUES);
		}
		return values;
	}
