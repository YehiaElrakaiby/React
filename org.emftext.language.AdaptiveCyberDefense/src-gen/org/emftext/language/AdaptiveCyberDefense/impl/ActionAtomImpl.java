...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Action Atom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.AdaptiveCyberDefense.impl.ActionAtomImpl#getActionvariable <em>Actionvariable</em>}</li>
 *   <li>{@link org.emftext.language.AdaptiveCyberDefense.impl.ActionAtomImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionAtomImpl extends EObjectImpl implements ActionAtom {
	/**
	...
	protected EClass eStaticClass() {
		return AdaptiveCyberDefensePackage.Literals.ACTION_ATOM;
	}
		...
		if (actionvariable != null && actionvariable.eIsProxy()) {
			...
			if (actionvariable != oldActionvariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AdaptiveCyberDefensePackage.ACTION_ATOM__ACTIONVARIABLE, oldActionvariable, actionvariable));
			}
		}
	...
	public void setActionvariable(ActionVariable newActionvariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptiveCyberDefensePackage.ACTION_ATOM__ACTIONVARIABLE, oldActionvariable, actionvariable));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AdaptiveCyberDefensePackage.ACTION_ATOM__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AdaptiveCyberDefensePackage.ACTION_ATOM__ACTIONVARIABLE:
				if (resolve) return getActionvariable();
				return basicGetActionvariable();
			case AdaptiveCyberDefensePackage.ACTION_ATOM__VALUE:
				return getValue();
		}
