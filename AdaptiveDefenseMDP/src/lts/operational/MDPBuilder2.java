...
public class MDPBuilder2 {
	 ...
	 * 				MAIN PART
	 */
	public MDPBuilder2(DomainDescription description, String option) {
		/*
		 *  Initialize
	...
	private void fillReward(Integer src_id, Integer dest_id, HashMap<String, String> src, HashMap<String, String> dst) {
		StringBuilder str = new StringBuilder();
		str.append(src_id).append("-").append(dest_id);
		if(!done.contains(str.toString())) {
	...
	private void fillRwdsMatrix(Integer src_id, Integer dest_id, BigDecimal rew) {
		for(String action_name : this.actions) {
			...
			r[src_id][dest_id][this.actions_id.get(action_name)]=rew.subtract(action_cost).doubleValue();
		}
